...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("start_date", sa.DateTime(timezone=True), nullable=False, comment="Import start timestamp (inclusive)"),
        sa.Column("end_date", sa.DateTime(timezone=True), nullable=False, comment="Import end timestamp (inclusive)"),
        sa.Column(
            "import_types",
            sa.JSON(),
            nullable=False,
